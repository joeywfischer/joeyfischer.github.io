...
st.title("Metlife Medius Template Generator")

invoice_file = st.file_uploader("Upload Metlife Invoice Excel File", type=["xlsx"])
...
if invoice_file and template_file and approver_name:
    try:
        # Load sheets
        df_invoice = pd.read_excel(invoice_file, sheet_name='Client Detail', engine='openpyxl')
        ...
        st.download_button(
            ...
            data=output,
            file_name="Updated_Metlife_Medius_Template.xlsx",
